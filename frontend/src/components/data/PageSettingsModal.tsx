...
export const DATA_CARD_DEFS: CardDef[] = [
  ...
  { key: 'adj_factor',  label: '除权因子', desc: '复权因子(Starter+ 或本地 public)',           defaultHiddenIfNoCap: true },
  ...
  { key: 'minute',      label: '分钟 K',   desc: '分钟级K线(全市场同步需 Pro+；单票分时可用公开源)',     defaultHiddenIfNoCap: true },
  { key: 'financials',  label: '财务数据', desc: '财报数据(Expert 或本地 public)',    defaultHiddenIfNoCap: true },
]
