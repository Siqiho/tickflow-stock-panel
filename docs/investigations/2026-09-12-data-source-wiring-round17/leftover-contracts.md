# Intentional leftover TickFlow contracts (round 17)
...
Closed in this round (not leftovers): backtest / live-agg / ETF / mainline / screener / overlay / mining / integrity / prune / quality / auction / dragon-tiger leftover daily-enriched reads and calendars after a custom daily switch; HTTP `/api/kline/minute-range` leftover parquet under a custom minute route. Leftover TickFlow still sees untagged partitions.
