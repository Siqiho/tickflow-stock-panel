...
Cloud environment result: backend target **734 passed**, 42 warnings (pre-existing Polars `streaming` deprecation / join_asof sortedness / ext_factors escape). No network. Isolated `DATA_DIR=/tmp/ot-data-source-wiring-round22`.
