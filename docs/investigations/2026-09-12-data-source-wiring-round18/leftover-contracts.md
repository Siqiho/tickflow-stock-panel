# Intentional leftover TickFlow contracts (round 18)
...
Closed in this round (not leftovers): market overview / daily quality / integrity except-fallback leftover globs; pipeline incremental / partial prune / index+ETF start / minute cover leftover calendars; extend-history and rebuild-enriched leftover day counts; backtest matrix leftover partitions; regime stale / RPS as_of / enriched lineage leftover reads; index/ETF status leftover calendars. Leftover TickFlow still sees untagged partitions.
