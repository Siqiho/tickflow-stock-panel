...
Closed in this round (not leftovers): leftover TickFlow single-symbol public / TDX minute; leftover TickFlow minute / depth / full-minute / adj after a custom daily; leftover TickFlow daily + public realtime overlay; unreadable leftover TickFlow date markers; DuckDB ungated remount fallback; HTTP ext leftover-glob of `instruments_ext`.
