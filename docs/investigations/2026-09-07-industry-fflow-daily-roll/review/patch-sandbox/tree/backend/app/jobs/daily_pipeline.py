...
def _run_industry_fund_flow_daily_roll(data_dir: Path) -> dict:
    ...
    try:
        ...
        return roll_industry_daily_from_h5(data_dir)
...
def run_now(
    ...
    # Industry daily continuation is attached after daily-K quality is already
    # decided. Failure here must not flip quality_ok or rewrite daily_days.
    industry_fund_flow_daily = _run_industry_fund_flow_daily_roll(repo.store.data_dir)
