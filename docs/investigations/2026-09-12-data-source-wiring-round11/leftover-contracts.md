# Intentional leftover TickFlow contracts (round 11)
...
Closed in this round (not leftovers): in-memory live enriched publish/overlay under custom daily, adj parquet provenance, watchlist/backtest/status/readiness/share-history financial bypasses, DuckDB financial and adj views scanning stale parquet.
