...
def compute_mainline_range(repo, data_dir: Path, start: date, end: date,
    ...
    # Production loader returns (map_df, count). Older / patched callers may
    # still hand back a bare DataFrame; unpacking that would turn columns into
    # Series and later explode on group_by.
