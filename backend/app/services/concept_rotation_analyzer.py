"""AI 板块轮动分析 — 从涨幅排名矩阵提炼主线/新晋/退潮信号。

数据来源:
  - rps_rotation.build_rps_rotation: 概念或行业涨幅排名矩阵
...
实现按上游 shy3130/tickflow-stock-panel main@e5b105d 的
concept_rotation_analyzer 迁入; focus 清洗沿用本地 market_recap 的 strip,
AI 访问守卫放在 HTTP 层 require_ai_http_access。
"""
